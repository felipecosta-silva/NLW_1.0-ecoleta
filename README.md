<h1 align=center>
<img src="https://user-images.githubusercontent.com/15041151/93255556-77692a00-f770-11ea-82ed-4694fbe6871a.png" />
</h1>


## **NLW_1.0 - NEXT LEVEL WEEK**

O **Next Level Week** foi o projeto que assumiu a responsabilidade dar continuidade a **Semana Omnistack**, com uma nova pegada a **[Rocketseat][rocketseat_site]** se reenventou e com isso veio o NLW.

<h3 align="center">

♻️ O Ecoleta é um projeto desenvolvido na semana **Next Level Week (1.0)** da **[Rocketseat][rocketseat_site]** utilizando as tecnologias ***TypeScript, Node, React e React Native***.

</h3>

## **:rocket: OBJETIVO**

O Ecoleta tem como finalidade **aproximar e estabelecer uma conexão** entre **empresas ou entidades que coletam resíduos** orgânicos e inorgânicos para com **quem necessita constantemente descartar os mesmos resíduos**. Desta forma solucionando o maior problema encontrada por quem quer fazer o **descaste de forma correta e segura** desse tipo de material, algo que facilita e muito o processo de recliclagem e reutilização.
...
Antes de tudo você precisa ter o <kbd>[NodeJS](https://nodejs.org/en/download/)</kbd> instalado na sua máquina. 

Se você estiver utilizando o **Linux**, você pode optar por utilizar o **yarn** no lugar do **npm**. Você pode instalar clicando nesse <kbd>[link][yarn]</kbd>.
...
<h3 align="center">
Feito com ❤️ por <a href="https://www.linkedin.com/in/felipe-costa-087ab7161silva/">Felipe Costa</a>
